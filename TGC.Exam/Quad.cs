...
namespace TGC.Exam
{
    public class Quad
    {
        ...
        {
            var graphicsDevice = Effecto.GraphicsDevice;
            ...
            foreach (var effectPass in Effecto.CurrentTechnique.Passes)
            {
                effectPass.Apply();
        ...
        {
            Effecto.CurrentTechnique = Effecto.Techniques["BasicShader"];
            Effecto.Parameters["ModelTexture"].SetValue(texture);
